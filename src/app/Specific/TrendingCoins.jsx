...
const TrendingCoins = () => {
  ...
  return (
    <div className=" h-[30%] w-[100%] mt-6 px-6 py-6  vsm:px-2" >
          ...
          <>
            <div className="flex items-center justify-between mb-4">
              <p className="text-[1rem] font-[600]">{i?.item?.name} ({i?.item.symbol}) </p>
                  ...
                  <p className={`bg-[#EBF9F4] text-[0.9rem] font-[500] rounded-[5px] w-[6vw] px-1  ${i?.item?.data?.price_change_percentage_24h?.aed > 0 ? "text-[green]" : "text-[red]"} flex items-center justify-center vsm:w-[25vw] `}>
                    {" "}
